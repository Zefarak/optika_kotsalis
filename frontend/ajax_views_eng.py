...
def ajax_change_cart_item_qty(request, pk):
    ...
    data['cart_items_result'] = render_to_string(template_name='frontend_eng/ajax_views/cart_items_container.html',
                                                 request=request,
                                                 context={'cart': cart,
                                                          })
    data['cart_result'] = render_to_string(template_name='frontend_eng/ajax_views/cart_container.html',
                                           request=request,
                                           context={'cart': cart,
...
def ajax_update_cate_shipping_method_view(request):
    ...
    data = dict()
    cart.refresh_from_db()
    data['result'] = render_to_string(template_name='frontend_eng/ajax_views/checkout_price_container.html',
                                      request=request,
                                      context={
                                          'cart': cart,

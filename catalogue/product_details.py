...
class Vendor(models.Model):
    ...
    title = models.CharField(unique=True, max_length=70, verbose_name="Ονομασία")
    vat = models.CharField(max_length=9, blank=True, null=True, verbose_name="ΑΦΜ")
    vat_city = models.CharField(max_length=100, blank=True, null=True, verbose_name="ΔΟΥ")
    phone = models.CharField(max_length=10, null=True, blank=True, verbose_name="Κινητό")
    phone1 = models.CharField(max_length=10, null=True, blank=True, verbose_name="Σταθερό")
    ...
    zipcode = models.CharField(max_length=40, null=True, blank=True, verbose_name='ΤΚ')
    description = models.TextField(null=True, blank=True, verbose_name="Σημειώσεις")
    ...
    def get_edit_url(self):
        return reverse('catalogue:vendor_detail', kwargs={'pk': self.id})
...
class Color(models.Model):
    ...
    def get_edit_url(self):
        return reverse('dashboard:color_edit_view', kwargs={'pk': self.id})

    def get_delete_url(self):
        return reverse('dashboard:delete_color_view', kwargs={'pk': self.id})
